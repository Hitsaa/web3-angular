...
// const tokenAbi = require('../../../../truffle_backend/build/contracts/Transfer.json');
import * as data from '../../../../truffle_backend/build/contracts/Transfer.json';
...
export class TransferService {
  ...
  // tokenAbi: any = (data as any).default;
